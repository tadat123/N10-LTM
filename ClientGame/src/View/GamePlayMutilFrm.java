...
//        
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Số ván đã chơi:");

        jLabel11.setText("Số ván đã thắng:");

        jLabel16.setText("{nickname}");

        jLabel17.setText("{sovanchoi}");

        jLabel18.setText("{sovanthang}");
        ...
        jLabel7.setText("Số ván đã chơi:");

        jLabel10.setText("Số ván đã thắng:");

        jLabel13.setText("{nickname}");

        jLabel14.setText("{sovanchoi}");

        jLabel15.setText("{sovanthang}");
